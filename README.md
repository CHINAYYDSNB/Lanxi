...
## 开发进度
- ✅ 服务器概览 (CPU/内存/磁盘/运行时间)
- ✅ 网站管理 (列表/启停/删除/Nginx编辑/SSL/日志/备份)
- ✅ 文件管理 (浏览/搜索/CRUD/上传/下载/编辑器)
- ✅ Docker 容器管理 (列表/详情/启停/日志/镜像/Compose)
- ✅ 应用商店 (浏览/详情/安装)
- ✅ 已安装应用管理 (列表/详情/更新/升级)
- ✅ 设置中心 (健康检测/连接检测/云备份/关于)
- ✅ AI 助手 (OpenAI 兼容/流式聊天/服务器上下文)
- ✅ 脚本商店 (索引/详情/下载/执行)
- ✅ SSH 终端管理
- ✅ WAF 管理
- ⏳ UI 重绘
